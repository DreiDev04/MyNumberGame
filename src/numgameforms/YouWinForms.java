...
public class YouWinForms extends javax.swing.JFrame {
    GameForms gameForms;
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font("Franklin Gothic Heavy", 1, 48)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(YouWinForms.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new YouWinForms().setVisible(true);
            }
        });
    }
